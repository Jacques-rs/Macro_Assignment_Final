...
output gap and inflation. The TR is a good predictor of the
...
for all $t=0,1,2,...,$ with $0 \ge \rho_{a} \le 1$, where the serially
...
$t=0,1,2,...$ with $0 \ge \rho_{u} <1$, where the serially uncorrelated
...
$$\frac{\partial L(C_t, h_t, B_t, M_t)}{\partial C_t}= a_t(\frac{1}{C_t-\gamma C_{t-1}})-\Lambda_t + E_t\beta a_{t+1}(-\gamma)(\frac{1}{C_{t+1}-\gamma C_t})$$
...
$$\frac{\partial L(C_t, h_t, B_t, M_t)}{\partial h_t}= (-1)( a_t) + (\frac{W_t}{P_t})(\Lambda_t)$$
