...
colours have been assigned to each rule in the visualisations of the
IRFs. The Taylor (TR) rule is black, the Interest Rate (IR) rule is
green, the Constant Money Growth (CMG) rule is purple and the Flexible
Money Growth (FMG) rule is blue.
...
\url{https://www.investopedia.com/terms/c/contractionary-policy}
{[}June, 2022{]}.
