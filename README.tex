...
\includegraphics{./figures/Table.jpeg}\{height=``50\%'',
width=``80\%''\}
...
\includegraphics{./figures/productivity-shock.jpeg}\{height=``60\%'',
width=``80\%''\}
...
\includegraphics{./figures/preference-shock.jpeg}\{height=``60\%'',
width=``80\%''\}
...
\includegraphics{./figures/money-demand-shock.jpeg}\{height=``60\%'',
width=``80\%''\}
...
\includegraphics{./figures/cost-push-shock.jpeg}\{height=``60\%'',
width=``80\%''\}
