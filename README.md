...
bought at the nominal price $P_t(i)$ in order to produce $Y_t$ units of
...
standard deviation $\sigma_{\theta}$. Thus, during each period $t$, the
...
The firm chooses $P_t(i)$ for all $t = 0,1,2,...$ to maximise its total
real market value proportional to:
...
\begin{figure}[H]
\includegraphics[width=0.65\linewidth]{./figures/money-demand-shock} \caption{Plots of Impulse Response Functions for a Money Demand Shock}\label{fig:Plot of Money Demand Shock IRFs}
\end{figure}
